  ...
  return (
    <form onSubmit={formHook.handleSubmit(submit)}>
      <Stack gap={2}>
        ...
        <InputForm id="last_name" label="Apellido" formHook={formHook} required />
        <InputForm id="phone_number" label="Teléfono" formHook={formHook} required />
        <InputForm id="email" label="Correo" formHook={formHook} required type="email" />
