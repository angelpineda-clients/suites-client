...
const RoomsForm = ({ data, formHook }: Props) => {
  ...
  return (
    <Grid container spacing={2}>
      <InputForm id="name" label="Nombre" required defaultValue={data?.name} formHook={formHook} />
      <InputCurrencyForm id="price" label="Precio" required formHook={formHook} />
      ...
      <InputForm id="description" label="Descripcion" formHook={formHook} size={12} />
